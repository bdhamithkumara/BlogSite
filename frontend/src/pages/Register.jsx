...
const Register = () => {
  return (
    ...
    <h1 className='text-[30px] uppercase text-[#ffffff] mb-[20px]'>register</h1>
    <form className='flex - flex-col p-[50px] bg-[#ffff] rounded-xl w-[350px] gap-[20px]'>
      ...
      <input required className='inputf' type="email" placeholder='email' />
      ...
      <span className='text-[12px] text-center'>Do you have an account? <Link to="/login">Login</Link></span>
    </form>
  </div>
  )
}
